...
try:
    LOGS.info("جارِ بدء بوت 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒 ✓")
...
async def startup_process():
    ...
    print("➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖")
    print("᯽︙بـوت 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒يعـمل بـنجاح ")
    print(
        f"تم تشغيل الانلاين تلقائياً ارسل {cmdhr}الاوامر لـرؤيـة اوامر السورس\
        \nللمسـاعدة تواصـل  https://t.me/WWEEHHHH"
    )
    print("➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖")
    await verifyLoggerGroup()
    await saves()
...
async def externalrepo():
    if Config.VCMODE:
        await install_externalrepo("https://github.com/jsbsjv/mmajab", "jepvc", "jepthonvc")
