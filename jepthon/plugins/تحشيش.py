...
#كـتابة المـلف وتعديل.    :   ميكائيل. .   اخمط وسمي روحك مطور فرخي 😂
...
async def permalink(mention):
    await edit_or_reply(mention, f"سماحة السيد ميكائيل مطور سورس 𝑠𝑜𝑢𝑛𝑑𝑤𝑎𝑣𝑒 @WWEEHHHH")
