...
async def amireallyalive(event):
    ...
    PING_TEXT = gvarstatus("PING_TEXT") or "**[ 𝗜 𝗝𝘂𝘀𝘁 𝗔𝘀𝗸𝗲𝗱 𝗙𝗼𝗿 𝗦𝗼𝗺𝗲 𝗣𝗲𝗮𝗰𝗲  ](t.me/WWEEHHHH)**"
    PING_IMG = gvarstatus("PING_PIC") or Config.P_PIC or "https://graph.org/file/150a19e179ee5c0382ad6.jpg"
